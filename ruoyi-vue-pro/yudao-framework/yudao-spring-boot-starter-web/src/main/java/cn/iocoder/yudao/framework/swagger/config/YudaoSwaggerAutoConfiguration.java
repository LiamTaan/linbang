...
public class YudaoSwaggerAutoConfiguration {
    ...
    public static GroupedOpenApi buildGroupedOpenApi(String group, String path) {
        return buildGroupedOpenApi(group,
                Arrays.asList("/admin-api/" + path + "/**", "/app-api/" + path + "/**"),
                null);
    }

    public static GroupedOpenApi buildGroupedOpenApi(String group, List<String> pathsToMatch,
