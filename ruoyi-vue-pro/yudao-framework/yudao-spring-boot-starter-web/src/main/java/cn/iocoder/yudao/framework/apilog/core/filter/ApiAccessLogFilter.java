...
public class ApiAccessLogFilter extends ApiRequestFilter {
    ...
    private void createApiAccessLog(HttpServletRequest request, LocalDateTime beginTime,
        ...
        try {
            ...
            log.error("[createApiAccessLog][url({}) traceId({}) 发生异常]",
                    request.getRequestURI(), accessLog.getTraceId(), th);
        }
    }
    ...
    private static String sanitizeMap(Map<String, ?> map, String[] sanitizeKeys) {
        return ApiLogSanitizer.sanitizeMap(map, sanitizeKeys);
    }

    private static String sanitizeJson(String jsonString, String[] sanitizeKeys) {
        return ApiLogSanitizer.sanitizeJson(jsonString, sanitizeKeys);
    }

    private static String sanitizeJson(CommonResult<?> commonResult, String[] sanitizeKeys) {
        return ApiLogSanitizer.sanitizeCommonResult(commonResult, sanitizeKeys);
    }
