...
public class EncryptTypeHandler extends BaseTypeHandler<String> {
    ...
    private static String decrypt(String value) {
        ...
        try {
            ...
            log.warn("Failed to decrypt value with mybatis encryptor, fallback to raw value for current environment", e);
            return value;
        }
    }
    ...
    public static String encrypt(String rawValue) {
        ...
        try {
            ...
            log.warn("Failed to encrypt value with mybatis encryptor, fallback to raw value for current environment", e);
            return rawValue;
        }
    }
