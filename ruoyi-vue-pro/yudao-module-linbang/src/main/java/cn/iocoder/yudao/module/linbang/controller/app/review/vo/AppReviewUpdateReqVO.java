...
@Schema(description = "用户 App - 编辑本人评价 Request VO")
@Data
public class AppReviewUpdateReqVO {

    @Schema(description = "评价 ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
    @NotNull(message = "评价不能为空")
    private Long id;

    @Schema(description = "星级", requiredMode = Schema.RequiredMode.REQUIRED, example = "4")
