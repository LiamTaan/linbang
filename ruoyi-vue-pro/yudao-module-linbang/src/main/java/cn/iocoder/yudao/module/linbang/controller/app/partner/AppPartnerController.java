...
public class AppPartnerController {
    ...
    @Operation(summary = "获取区域合作商工作台", description = "区域合作商当前角色专属接口，仅返回当前合作商辖区内的协同数据。")
    ...
    @Operation(summary = "获取合作商辖区详情", description = "区域合作商当前角色专属接口，仅返回当前合作商辖区范围内的数据。")
    ...
    @Operation(summary = "获取合作商辖区内入驻初审分页", description = "区域合作商当前角色专属接口，仅返回当前合作商辖区内待处理或历史入驻初审数据。")
    ...
    @Operation(summary = "获取合作商辖区内入驻初审详情", description = "区域合作商当前角色专属接口，仅允许查看当前合作商辖区内的入驻申请详情。")
    ...
    @Operation(summary = "合作商执行入驻初审", description = "区域合作商当前角色专属接口，仅允许处理当前合作商辖区内的入驻申请。")
    ...
    @Operation(summary = "获取合作商辖区纠纷分页", description = "区域合作商当前角色专属接口，仅返回当前合作商辖区内的投诉和申诉数据。")
    ...
    @Operation(summary = "合作商发起纠纷协调", description = "区域合作商当前角色专属接口，仅允许对当前辖区纠纷发起协调或升级平台终审。")
    ...
    @Operation(summary = "获取合作商价格建议分页", description = "区域合作商当前角色专属接口，仅返回当前合作商辖区价格建议单记录。")
    ...
    @Operation(summary = "获取合作商价格建议详情", description = "区域合作商当前角色专属接口，仅允许查看当前合作商辖区价格建议单详情。")
    ...
    @Operation(summary = "创建合作商价格建议", description = "区域合作商当前角色专属接口，仅允许对当前合作商辖区提交价格建议单。")
    ...
    @Operation(summary = "撤回合作商价格建议", description = "区域合作商当前角色专属接口，仅允许撤回当前合作商自己的待审核价格建议单。")
    ...
    @Operation(summary = "获取合作商辖区推广数据", description = "区域合作商当前角色专属接口，仅返回当前合作商辖区内基于真实用户归属、推广关系、佣金单和推广成交额的推广数据。")
    ...
    @Operation(summary = "获取合作商会议通知/上级指令分页", description = "区域合作商当前角色专属接口，仅返回当前合作商可读的会议通知和上级指令。")
    ...
    @Operation(summary = "获取合作商会议通知/上级指令详情", description = "区域合作商当前角色专属接口，仅允许查看当前合作商可读的会议通知和上级指令详情。")
