...
public class AdminDynamicKeyAspect {
    ...
    private static final Set<String> PROTECTED_URIS = Collections.unmodifiableSet(new HashSet<String>(Arrays.asList(
            ...
            "/admin-api/wallet/divide-rule/delete",
            "/admin-api/wallet/divide-rule/delete-list",
            "/admin-api/review/credit-rule/create",
            "/admin-api/review/credit-rule/update",
            "/admin-api/review/credit-rule/delete",
            "/admin-api/review/credit-rule/delete-list",
            "/admin-api/order/split-rule/create",
            "/admin-api/order/split-rule/update",
            "/admin-api/order/split-rule/delete",
            "/admin-api/linbang/match/strategy/update",
            ...
            "/admin-api/message/campaign/approve",
            "/admin-api/message/campaign/reject",
            "/admin-api/message/campaign/execute-now",
            "/admin-api/message/push-task/manual-send",
            "/admin-api/message/push-task/retry"
    )));
