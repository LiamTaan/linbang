...
(`id`, `parent_id`, `category_name`, `category_level`, `sort_no`, `icon`, `default_pricing_mode`, `supported_pricing_modes`, `support_split`, `quantity_unit_label`, `quantity_split_enabled`, `split_default_mode`, `engineering_category_flag`, `support_invoice`, `risk_level`, `labor_category_flag`, `force_agreement_type`, `invoice_rate_reminder_text`, `status`, `tenant_id`, `creator`, `create_time`, `updater`, `update_time`, `deleted`)
VALUES
(340001, 0, '家政保洁', 1, 10, 'ep:house', 'HOURLY', '["HOURLY","BY_UNIT"]', b'0', '小时', b'0', 'DIRECT', b'0', b'1', 'LOW', b'0', 'TRADE_GUARANTEE', '开票需求通常会降低接单率，请确认是否继续', 'ENABLE', 1, 'admin', NOW(), 'admin', NOW(), b'0'),
(340002, 0, '家居维修', 1, 20, 'ep:tools', 'CONTRACT', '["FIXED_PRICE","CONTRACT","BY_UNIT"]', b'1', '项', b'0', 'BY_PROCESS', b'1', b'1', 'MEDIUM', b'1', 'PROJECT_ESCROW', '开票需求通常会降低接单率，请确认是否继续', 'ENABLE', 1, 'admin', NOW(), 'admin', NOW(), b'0'),
(340003, 0, '家电清洗', 1, 30, 'ep:operation', 'FIXED_PRICE', '["FIXED_PRICE","BY_UNIT"]', b'0', '台', b'0', 'DIRECT', b'0', b'1', 'LOW', b'0', 'TRADE_GUARANTEE', '开票需求通常会降低接单率，请确认是否继续', 'ENABLE', 1, 'admin', NOW(), 'admin', NOW(), b'0'),
(340004, 0, '跑腿代办', 1, 40, 'ep:van', 'HOURLY', '["HOURLY","FIXED_PRICE"]', b'0', '单', b'0', 'DIRECT', b'0', b'0', 'MEDIUM', b'0', 'TRADE_GUARANTEE', NULL, 'ENABLE', 1, 'admin', NOW(), 'admin', NOW(), b'0'),
(340005, 0, '社区安装', 1, 50, 'ep:box', 'CONTRACT', '["FIXED_PRICE","CONTRACT","BY_UNIT"]', b'1', '项', b'0', 'BY_PROCESS', b'1', b'1', 'MEDIUM', b'1', 'PROJECT_ESCROW', '开票需求通常会降低接单率，请确认是否继续', 'ENABLE', 1, 'admin', NOW(), 'admin', NOW(), b'0'),
(340101, 340001, '日常保洁', 2, 11, NULL, 'HOURLY', '["HOURLY"]', b'0', '小时', b'1', 'BY_PROGRESS', b'0', b'1', 'LOW', b'0', 'TRADE_GUARANTEE', '开票需求通常会降低接单率，请确认是否继续', 'ENABLE', 1, 'admin', NOW(), 'admin', NOW(), b'0'),
(340102, 340001, '深度清洁', 2, 12, NULL, 'FIXED_PRICE', '["FIXED_PRICE","BY_UNIT"]', b'1', '次', b'0', 'BY_CONTENT', b'0', b'1', 'MEDIUM', b'0', 'TRADE_GUARANTEE', '开票需求通常会降低接单率，请确认是否继续', 'ENABLE', 1, 'admin', NOW(), 'admin', NOW(), b'0'),
(340201, 340002, '水电维修', 2, 21, NULL, 'CONTRACT', '["FIXED_PRICE","CONTRACT","BY_UNIT"]', b'1', '项', b'0', 'BY_PROCESS', b'1', b'1', 'MEDIUM', b'1', 'PROJECT_ESCROW', '开票需求通常会降低接单率，请确认是否继续', 'ENABLE', 1, 'admin', NOW(), 'admin', NOW(), b'0'),
(340202, 340002, '门锁门窗维修', 2, 22, NULL, 'FIXED_PRICE', '["FIXED_PRICE","BY_UNIT"]', b'1', '扇', b'1', 'BY_CONTENT', b'1', b'1', 'MEDIUM', b'1', 'PROJECT_ESCROW', '开票需求通常会降低接单率，请确认是否继续', 'ENABLE', 1, 'admin', NOW(), 'admin', NOW(), b'0'),
(340301, 340003, '空调清洗', 2, 31, NULL, 'FIXED_PRICE', '["FIXED_PRICE","BY_UNIT"]', b'0', '台', b'1', 'BY_CONTENT', b'0', b'1', 'LOW', b'0', 'TRADE_GUARANTEE', '开票需求通常会降低接单率，请确认是否继续', 'ENABLE', 1, 'admin', NOW(), 'admin', NOW(), b'0'),
(340302, 340003, '油烟机清洗', 2, 32, NULL, 'FIXED_PRICE', '["FIXED_PRICE","BY_UNIT"]', b'0', '台', b'1', 'BY_CONTENT', b'0', b'1', 'LOW', b'0', 'TRADE_GUARANTEE', '开票需求通常会降低接单率，请确认是否继续', 'ENABLE', 1, 'admin', NOW(), 'admin', NOW(), b'0'),
(340401, 340004, '同城跑腿', 2, 41, NULL, 'HOURLY', '["HOURLY","FIXED_PRICE"]', b'0', '单', b'0', 'DIRECT', b'0', b'0', 'MEDIUM', b'0', 'TRADE_GUARANTEE', NULL, 'ENABLE', 1, 'admin', NOW(), 'admin', NOW(), b'0'),
(340402, 340004, '代办代购', 2, 42, NULL, 'FIXED_PRICE', '["FIXED_PRICE"]', b'0', '单', b'0', 'DIRECT', b'0', b'0', 'MEDIUM', b'0', 'TRADE_GUARANTEE', NULL, 'ENABLE', 1, 'admin', NOW(), 'admin', NOW(), b'0'),
(340501, 340005, '家具安装', 2, 51, NULL, 'CONTRACT', '["FIXED_PRICE","CONTRACT","BY_UNIT"]', b'1', '件', b'1', 'BY_PROCESS', b'1', b'1', 'MEDIUM', b'1', 'PROJECT_ESCROW', '开票需求通常会降低接单率，请确认是否继续', 'ENABLE', 1, 'admin', NOW(), 'admin', NOW(), b'0'),
(340502, 340005, '卫浴安装', 2, 52, NULL, 'CONTRACT', '["FIXED_PRICE","CONTRACT","BY_UNIT"]', b'1', '件', b'1', 'BY_PROCESS', b'1', b'1', 'MEDIUM', b'1', 'PROJECT_ESCROW', '开票需求通常会降低接单率，请确认是否继续', 'ENABLE', 1, 'admin', NOW(), 'admin', NOW(), b'0');
...
(380006, 'lb_qualification_expire_reminder', '资质到期提醒通知', 'QUALIFICATION_EXPIRE_REMINDER', 'COMPLIANCE', 'BIZ', 'APP_POPUP', '资质到期提醒', '您的资质临近到期，请尽快更新，避免影响接单。', 'APP_PAGE', '/pages/certificate/certificate', NULL, NULL, '您的资质即将到期，请尽快更新。', 60, 'ENABLE', 1, 'admin', NOW(), 'admin', NOW(), b'0'),
(380007, 'lb_qualification_expire_disable', '资质到期限制接单通知', 'QUALIFICATION_EXPIRE_DISABLE', 'COMPLIANCE', 'BIZ', 'APP_POPUP', '资质已到期', '您的资质已到期，当前已限制接单，请完成更新后恢复。', 'APP_PAGE', '/pages/certificate/certificate', NULL, NULL, '您的资质已到期，当前已限制接单。', 70, 'ENABLE', 1, 'admin', NOW(), 'admin', NOW(), b'0'),
...
(380106, 'lb_special_cert_audited', '专项资质审核通知', 'SYSTEM_NOTICE', 'COMPLIANCE', 'BIZ', 'APP_POPUP', '专项资质审核结果', '您的专项资质审核结果已更新，请及时查看。', 'APP_PAGE', '/pages/certificate/certificate', NULL, NULL, '您的专项资质审核结果已更新，请及时查看。', 160, 'ENABLE', 1, 'admin', NOW(), 'admin', NOW(), b'0'),
...
(380110, 'lb_cert_exemption_audited', '证件豁免审核结果通知', 'SYSTEM_NOTICE', 'COMPLIANCE', 'BIZ', 'APP_POPUP', '证件豁免审核结果', '您的证件豁免申请审核结果已更新，请及时查看处理。', 'APP_PAGE', '/pages/certificate/certificate', NULL, NULL, '您的证件豁免审核结果已更新，请及时查看。', 200, 'ENABLE', 1, 'admin', NOW(), 'admin', NOW(), b'0');
