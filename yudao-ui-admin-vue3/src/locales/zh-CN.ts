export default {
  ...
  login: {
    welcome: '欢迎进入邻里互助管理后台',
    message: '围绕订单履约、服务商审核、资金风控和信用治理的一体化平台工作台',
    tenantname: '租户名称',
    username: '用户名',
    password: '密码',
    code: '验证码',
  ...
  sys: {
    ...
    login: {
      backSignIn: '返回',
      signInFormTitle: '管理端登录',
      ssoFormTitle: '三方授权',
      mobileSignInFormTitle: '手机登录',
      qrSignInFormTitle: '二维码登录',
      signUpFormTitle: '注册',
      forgetFormTitle: '找回登录密码',
      signInTitle: '邻里互助管理后台',
      signInDesc: '使用管理账号进入平台工作台，统一处理审核、风控、资金与履约事务。',
      policy: '我同意xxx隐私政策',
