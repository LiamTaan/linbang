  ...
  <ContentWrap>
    ...
    >
      ...
      <el-form-item label="处罚类型" prop="punishType">
        <el-input
          v-model="queryParams.punishType"
          placeholder="如 RESTRICT_PUBLISH"
          clearable
          class="!w-220px"
          @keyup.enter="handleQuery"
        />
  ...
  <Dialog v-model="detailVisible" title="处罚执行日志详情" width="760px">
    <el-descriptions :column="2" border>
      ...
      <el-descriptions-item label="来源记录"
        >{{ detailData?.sourceRecordType || '-' }} /
        {{ detailData?.sourceRecordId || '-' }}</el-descriptions-item
      >
