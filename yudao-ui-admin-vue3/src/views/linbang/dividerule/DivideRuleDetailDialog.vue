<template>
  <Dialog v-model="dialogVisible" title="分账规则详情" width="760px" :loading="detailLoading">
    ...
    <el-descriptions :column="3" border>
      <el-descriptions-item label="服务商比例">{{
        detailData.merchantRate ?? 0
      }}</el-descriptions-item>
      <el-descriptions-item label="平台比例">{{
        detailData.platformRate ?? 0
      }}</el-descriptions-item>
      <el-descriptions-item label="合作商比例">{{
        detailData.partnerRate ?? 0
      }}</el-descriptions-item>
      <el-descriptions-item label="推广员比例">{{
        detailData.promoterRate ?? 0
      }}</el-descriptions-item>
    ...
    <el-descriptions :column="3" border>
      ...
      <el-descriptions-item label="收益侧比例">{{
        detailData.incomeRate ?? 0
      }}</el-descriptions-item>
