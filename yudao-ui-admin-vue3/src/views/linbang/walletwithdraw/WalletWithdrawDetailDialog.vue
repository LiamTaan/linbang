  ...
  <Dialog v-model="dialogVisible" title="提现详情" width="760px" :loading="detailLoading">
    <el-descriptions :column="2" label-class-name="desc-label">
      ...
      <el-descriptions-item label="实际到账金额">{{
        detailData.realAmount ?? '-'
      }}</el-descriptions-item>
      <el-descriptions-item label="状态">
        <dict-tag
          v-if="detailData.status"
          :type="DICT_TYPE.LB_WITHDRAW_STATUS"
      ...
      <el-descriptions-item label="出款转账 ID">{{
        detailData.payTransferId ?? '-'
      }}</el-descriptions-item>
      <el-descriptions-item label="出款单号">{{
        detailData.payTransferNo ?? '-'
      }}</el-descriptions-item>
    ...
    <el-descriptions :column="1" border direction="vertical">
      ...
      <el-descriptions-item label="出款失败原因">{{
        detailData.transferErrorMsg || '-'
      }}</el-descriptions-item>
    </el-descriptions>
    <el-divider />
    ...
    <el-descriptions :column="2" border>
      ...
      <el-descriptions-item label="银行卡状态">{{
        formatEnableStatus(detailData.bankCard?.status)
      }}</el-descriptions-item>
    </el-descriptions>
    <el-divider />
