...
export enum DICT_TYPE {
  ...
  LB_ORDER_UNIT_STATUS = 'lb_order_unit_status', // 邻里互助单元订单状态
  LB_WITHDRAW_STATUS = 'lb_withdraw_status', // 邻里互助提现状态
  LB_COMPLAINT_STATUS = 'lb_complaint_status', // 邻里互助投诉状态
  LB_APPEAL_STATUS = 'lb_appeal_status', // 邻里互助申诉状态
  LB_ROLE_APPLY_STATUS = 'lb_role_apply_status', // 邻里互助身份申请状态
  LB_PRICE_REPORT_AUDIT_STATUS = 'lb_price_report_audit_status', // 邻里互助价格申报审核状态
  LB_MESSAGE_PUSH_TASK_STATUS = 'lb_message_push_task_status', // 邻里互助消息推送任务状态
